function Gui(){
    ...
    this.create_contact_element = function(contact){
        ...
        <div class="d-flex my-3">
            ...
            <div class="flex-grow-1 d-flex flex-column mx-2">
                <div class="element name">${contact.name.split(" ").map(word=>word.charAt(0).toUpperCase() + word.slice(1)).join(" ")}</div>
        ...
        <div class="reminder hide"  data-id=${contact.id}>
            ...
            <div class="d-flex py-2">
                <div class="col-4 col-sm-3 px-0 new-date">${(new Date()).toLocaleString("ro-Ro", {year: 'numeric', month: '2-digit', day: '2-digit' })}</div>
    ...
    this.remove_contact_elements = function(){
        $(this.app_body.children).each(function(){
            this.remove();
        });
    }
